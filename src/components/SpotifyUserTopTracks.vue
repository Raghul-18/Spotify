      ...
      <div v-if="!tokenHasExpired">
        <div class="panel tracks" v-if="spotifyTracks">
          ...
          <p class="panel-intro">
            ...
            me music similar to' button in the respective track section
          </p>
            ...
            <div class="track__options">
              ...
              <div>
                <button
                  ...
                  v-on:click.stop="musicAnalysisRedirect(track.id, track.artists[0].id)"
                >
  ...
  export default {
    ...
    methods: {
      ...
      async getSpotifyUserTopTracks(url) {
        this.spotifyUserTopTracks = await this.SpotifyApiInterface.spotifyGetFetchRequest(url);
      },
      bindSpotifyUserTopTracks() {
        ...
        // Add this line to display the top tracks' names in the console
        console.log("Top Tracks:", this.spotifyTracks.map(track => track.name));
      },
